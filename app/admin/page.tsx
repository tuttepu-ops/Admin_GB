...
type Profile = {   id: string;   full_name: string | null;   phone: string | null;    email: string;   auth_phone: string;    created_at: string;   updated_at: string;    auth_created_at: string | null;   last_sign_in_at: string | null;   email_confirmed_at: string | null; };
...
export default function Admin(){
 ...
 const [tab,setTab]=useState('dashboard'); const [query,setQuery]=useState(''); const [status,setStatus]=useState('all'); const [payment,setPayment]=useState('all'); const [fromDate,setFromDate]=useState(''); const [toDate,setToDate]=useState(''); const [sort,setSort]=useState('newest'); const [selected, setSelected] =   useState<Order | null>(null);  const [selectedCustomer, setSelectedCustomer] =   useState<Profile | null>(null);  const [mobileMenu, setMobileMenu] =   useState(false);
