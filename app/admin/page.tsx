...
function Status({
  ...
  return (
    <span
      className={`status status-${children}`}
    >
      {children.replaceAll(
        '_',
        ' '
...
Thank you for choosing Godavari Basket.`;

  window.open(
    `https://wa.me/${o.delivery_mobile.replace(
      /\D/g,
      ''
...
<p>
DELIVERY ADDRESS · ${o.order_number}
</p>
...
export default function Admin() {
   ...
   *
   * - Every 15 seconds
   * - When Admin tab becomes visible
   * - When Admin PWA/browser gets focus
   */
  useEffect(() => {
    if (
      !logged ||
              ...
              <div className="filters">
                ...
                <div className="search">
                  ...
                  <input
                    ...
                    placeholder="Order, customer name, mobile, coupon, referral…"
                  />
          ...
          {tab ===
            ...
            <div className="grid-two">
              ...
              <div className="panel">
                ...
                <p className="muted">
                  Enable notifications on each phone/browser that should receive new-order alerts.
                </p>
            ...
            <div className="data-page">
              ...
              <div className="danger">
                ...
                <div>
                  ...
                  <p>
                    Destructive actions are blocked unless{' '}
                    <b>
                      ALLOW_DATA_CLEAR=true
                    </b>{' '}
      ...
      <div className="panel-list">
        ...
        {rows.map(
          (
            ...
            const link =
              `${STORE_URL}/?ref=${encodeURIComponent(
                i.referral_code
              )}`;
