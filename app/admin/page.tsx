      ...
      <div className="panel-list">
        {rows.map(i=>{
          ...
          const link=typeof window!=='undefined'
            ? `${window.location.origin.replace(':3001',':3000')}/?ref=${i.referral_code}`
            : `/?ref=${i.referral_code}`;
          return (
